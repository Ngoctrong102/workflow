...
public class KafkaConfig {
    ...
    /**
     * Create consumer factory for specific broker configuration
     */
    public ConsumerFactory<String, String> createConsumerFactory(List<String> brokers, String consumerGroup, String offset) {
        Map<String, Object> props = new HashMap<>();
